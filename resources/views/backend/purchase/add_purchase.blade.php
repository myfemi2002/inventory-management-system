...
<div class="card w-100">
    <div class="card-body border-top">
        <form id="myForm" class="form" method="POST" action="{{ route('purchase.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="mb-3 form-group">
                        ...
                        <input  name="purchase_no" type="text"class="form-control" value="PUR-{{ substr(rand(0,time()),0,7) }}" placeholder="Purchase No" id="purchase_no" readonly required>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="mb-3 form-group">
                        ...
                        <select name="supplier_id" class="select2 form-control custom-select" id="supplier_id" style="width: 100%; height: 36px" required>
    ...
    <button type="submit" class="btn btn-info rounded-pill px-4 waves-effect waves-light"> Add More</button>
    </div>
    </div>
    </div> --}}
    </form>
...
<div class="card w-100">
    <div class="card-body border-top">
        <form method="post" action="{{ route('purchase.store') }}">@csrf
