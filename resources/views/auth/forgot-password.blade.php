...
<html dir="ltr">
  <head>
    ...
    <title>:: Forgot Password :: Newinfo POS</title>
          ...
          <div>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <form method="POST" class="form-horizontal mt-3"  action="{{ route('password.email') }}">@csrf
                  ...
                  <div class="mb-3 text-center">
                    <div class="col-xs-12 pb-3">
                      <button  class="btn d-block w-100 btn-lg btn-light-info text-info" type="submit"> Email Password Reset Link </button>
                    </div>
                  </div>
                </form>
              </div>
